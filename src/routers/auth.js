...
import { loginWithGoogleOAuthSchema } from '../utils/loginWithGoogleOAuthSchema.js';
...
authRouter.get('/get-oauth-url', s.getGoogleOAuthUrlController);

authRouter.post(
  '/confirm-oauth',
  validateBody(loginWithGoogleOAuthSchema),
  s.loginWithGoogleController,
);
